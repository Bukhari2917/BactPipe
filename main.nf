...
process BUSCO {
    ...
    script:
    """
    busco -i ${assembly} -o busco_results -l bacteria_odb10 -m genome --cpu ${params.threads} || echo "BUSCO failed" > busco_results.txt
    """
}
...
process MULTIQC {
    ...
    script:
    """
    multiqc ${params.outdir} --filename multiqc_report.html --force || true
    """
}
